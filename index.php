    ...
    <footer class="footer" id="footer">
      <div class="main-content">
        <div class="left box">
          ...
          <div class="content">
            <p>
            Welcome to [Bookstore Name], where every page holds a story,
            and every shelf invites exploration. Nestled in the heart of 
            [City/Town Name], we are more than just a bookstore;
            we're a sanctuary for book lovers, a community hub for 
            literary enthusiasts, and a haven for those who seek solace in the written word.
            </p>
            <br />
            <p>
        ...
        <div class="center box">
          ...
          <div class="content">
            ...
            <div class="phone">
              ...
              <span class="text">+91 79049070410</span>
            </div>
            <div class="email">
              <span class="fas fa-envelope"></span>
              <span class="text">221501087@rajalakshmi.edu.in</span>
            </div>
          </div>
        </div>
        <div class="right box">
