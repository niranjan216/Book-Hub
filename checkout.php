...
<body>
    ...
    <div class="cart-box-main">
        ...
        if (isset($_POST["submit"])) {
            $sql = "insert into checkout(first_name,last_name,user_name,email_id,address,address2,country,state,pincode) values('{$_POST["firstname"]}','{$_POST["lastname"]}','{$_POST["username"]}','{$_POST["email"]}','{$_POST["address"]}','{$_POST["address2"]}','{$_POST["country"]}','{$_POST["state"]}','{$_POST["zip"]}')";
            $result = mysqli_query($conn, $sql);
            if ($result) {
                header("location:index.php");
            } else {
                echo "unsuccesfull payment";
            }
        }
        ?>
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-6 mb-3">
                <div class="row">
                    ...
                    <div class="col-12 d-flex shopping-box"> <a href="checkout.php" class="ml-auto btn hvr-hover"
                            name="submit">Place Order</a> </div>
                </div>
            </div>
        </div>
